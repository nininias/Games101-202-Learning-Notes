...
![image-20241002165256287](D:\TyporaImage\image-20241002165256287.png)
...
![image-20241002233641668](D:\TyporaImage\image-20241002233641668.png)
...
![image-20241003020408016](D:\TyporaImage\image-20241003020408016.png)
...
<img src="D:\TyporaImage\image-20241006142958811.png" alt="image-20241006142958811" style="zoom:50%;" />
...
![image-20241009222613162](D:\TyporaImage\image-20241009222613162.png)
...
- #### 逐段贝塞尔曲线（piecewise Bezier Curves）
  ...
  - #### 连续的阶数
    ...
    -  **C^1^连续：**也叫一阶导连续，保证C^0^连续的情况下，切线也连续，即：a~n~ = b~0~ = 1/2 * （a~n-1~ + b~1~）。也就是切线的方向相反，长度等长<img src="D:\TyporaImage\image-20241013165053686.png" alt="image-20241013165053686" style="zoom:33%;" />**——无突变**
...
- **Bezier Surfaces**
  ...
  - 怎么通过贝塞尔曲线去获得贝塞尔曲面？
    - <img src="D:\TyporaImage\image-20241013170405373.png" alt="image-20241013170405373" style="zoom:33%;" />
    - 上图是由4 x 4个控制点得到的
    - 步骤为：先水平/竖直方向先进行插值得到4条贝赛尔曲线<img src="D:\TyporaImage\image-20241013170745108.png" alt="image-20241013170745108" style="zoom:25%;" />，然后再不同的时间t上位置不同，能水平插值出一系列的曲线<img src="D:\TyporaImage\image-20241013170829018.png" alt="image-20241013170829018" style="zoom:33%;" />。对所有时间t上的积累能够画出一个面：<img src="D:\TyporaImage\image-20241013170901463.png" alt="image-20241013170901463" style="zoom:33%;" />，16个点所经历的：![image-20241013171002119](D:\TyporaImage\image-20241013171002119.png)
...
- ### Loop Subdivision
  ...
  - **只能用在三角形面。**
  - 连接三角形的中点生成更多的三角形。<img src="D:\TyporaImage\image-20241013193120906.png" alt="image-20241013193120906" style="zoom:33%;" />
  - 对于新/旧顶点，采用不同的移动规则来改变顶点位置。
    - **新：**加权平均（具体算法推到不介绍）![image-20241013193718572](D:\TyporaImage\image-20241013193718572.png)
    - **旧：**根据周遭数量进行加权平均。如果引入的u的规定：如果n=3，则u = 3/（8n），否则都是3/16![image-20241013195030817](D:\TyporaImage\image-20241013195030817.png)
...
- ### Catmull-Clark Subdivision(General Mesh)
  ...
  - <img src="D:\TyporaImage\image-20241013195736522.png" alt="image-20241013195736522" style="zoom:33%;" />
  - 很有用。第一次就会增加“非四边形面”个奇异点。<img src="D:\TyporaImage\image-20241013200450617.png" alt="image-20241013200450617" style="zoom:33%;" />
  - 根据三个边的中点进行相连，然后形成形成一个新的奇异点。之后——
    - 非四边形面消失了，不会再增加“非四边形面”个奇异点
    - <img src="D:\TyporaImage\image-20241013200311395.png" alt="image-20241013200311395" style="zoom:50%;" />
...
- 方法一：**边坍缩**
  ...
  - <img src="D:\TyporaImage\image-20241013202029736.png" alt="image-20241013202029736" style="zoom:50%;" />
  ...
  - 我们要：①最小的代价取最小的二次度量误差；②以最小的代价，对二次度量误差做更新。——堆结构排序<img src="D:\TyporaImage\image-20241013202821554.png" alt="image-20241013202821554" style="zoom:67%;" />
...
- ### 软阴影
  ...
  - 由近及远会变淡
  - 由近及远会变软
  - ![image-20241013210023253](D:\TyporaImage\image-20241013210023253.png)
...
- 遗留的光栅化问题（有光栅化解决办法但是很麻烦）
  - **软阴影**
  - **Glossy reflection**——毛玻璃 <img src="D:\TyporaImage\image-20241014171041069.png" alt="image-20241014171041069" style="zoom:67%;" />
  - **间接光**
...
![image-20241014173825207](D:\TyporaImage\image-20241014173825207.png)
...
![image-20241014174808769](D:\TyporaImage\image-20241014174808769.png)<img src="D:\TyporaImage\image-20241014174817398.png" alt="image-20241014174817398" style="zoom:50%;" />
...
<img src="D:\TyporaImage\image-20241015000153677.png" alt="image-20241015000153677" style="zoom:67%;" />
...
![image-20241015000845175](D:\TyporaImage\image-20241015000845175.png)
...
![image-20241015001343510](D:\TyporaImage\image-20241015001343510.png)
...
- 相切——一个交点
- 相交——两个交点
  - ![image-20241015001644387](D:\TyporaImage\image-20241015001644387.png)
...
![image-20241015004619333](D:\TyporaImage\image-20241015004619333.png)
...
- 光线对三角形所在平面求交点，然后判断交点是否在三角形里面
  ...
  - <img src="D:\TyporaImage\image-20241015010903609.png" alt="image-20241015010903609" style="zoom:50%;" />
  - 即——交点以射线的值代入，然后与三角形上的某一点形成向量。这个向量与法线点乘为0——垂直，即可求得t。代入t到射线的值，得到交点。判断交点是否在三角形内。
  - ![image-20241015011302002](D:\TyporaImage\image-20241015011302002.png)
...
![image-20241015011756486](D:\TyporaImage\image-20241015011756486.png)
...
![image-20241018210156492](D:\TyporaImage\image-20241018210156492.png)
...
![image-20241015012550991](D:\TyporaImage\image-20241015012550991.png)



​         **长方体**——理解成三个对面形成的交集。<img src="D:\TyporaImage\image-20241015012822257.png" alt="image-20241015012822257" style="zoom:33%;" />
...
- ### 二维情况下
  ...
  - ![image-20241015013655358](D:\TyporaImage\image-20241015013655358.png)
...
-  ### 三维情况下
  ...
  - ![image-20241015014631235](D:\TyporaImage\image-20241015014631235.png)
...
- ### t的求法
  ...
  - 根据公式：<img src="D:\TyporaImage\image-20241019163508498.png" alt="image-20241019163508498" style="zoom:67%;" />

  - 倒推为<img src="D:\TyporaImage\image-20241019163522388.png" alt="image-20241019163522388" style="zoom:67%;" />
...
![image-20241015015552726](D:\TyporaImage\image-20241015015552726.png)
...
- **均匀格子——场景预处理**
  ...
  - 然后判断光线是否与物体相交。  
    ...
    - ![image-20241015142040337](D:\TyporaImage\image-20241015142040337.png)
    - **所以那种加速效果比较好？**
    - 上面这种**均匀格子**在某些场合确实有用，但我们主要用下面的方法
- **空间划分**
  - 想法：密集的地方格子多一点，稀疏的地方格子少一点
  - 三种空间划分的结构：八叉树，KD树，BSP树
  - <img src="D:\TyporaImage\image-20241015144431613.png" alt="image-20241015144431613" style="zoom: 33%;" />
  - 八叉树
...
![image-20241015150610833](D:\TyporaImage\image-20241015150610833.png)
...
![image-20241015152238009](D:\TyporaImage\image-20241015152238009.png)
...
怎么判断三角形是否在格子里面呢？或者说，物体根哪个格子有交集？判断不了，难<img src="D:\TyporaImage\image-20241015152822226.png" alt="image-20241015152822226" style="zoom:50%;" />！**很难**。
...
![image-20241015153815045](D:\TyporaImage\image-20241015153815045.png)
...
- ![image-20241015161132359](D:\TyporaImage\image-20241015161132359.png)
...
![image-20241015194231546](D:\TyporaImage\image-20241015194231546.png)
...
**能量<img src="D:\TyporaImage\image-20241015194438409.png" alt="image-20241015194438409" style="zoom:50%;" />**

**——焦耳**

![image-20241015193750638](D:\TyporaImage\image-20241015193750638.png)
...
![image-20241015193759116](D:\TyporaImage\image-20241015193759116.png)  
...
![image-20241015194453111](D:\TyporaImage\image-20241015194453111.png)——能量



![image-20241015194649501](D:\TyporaImage\image-20241015194649501.png)
...
![image-20241015195129093](D:\TyporaImage\image-20241015195129093.png)
...
- ### 单位立体角
  ...
  - **==dw = dA/r^2^ = sinθ dθ d∅==**
  - ![image-20241015195607611](D:\TyporaImage\image-20241015195607611.png)
  - 立体角是三维的，它是一个**面**的**角度**
  - 式子推导可得面积为dA——面积得是正对球心的 
  - 面积除以半径的平方——dw
  -  将整个圆的单位立体角积分起来那就是4π
  - <img src="D:\TyporaImage\image-20241015195749973.png" alt="image-20241015195749973" style="zoom:50%;" />
...
- ### 微分立体角
  ...
  - **竖直**方向用r 来进行**dθ**的累积
  - ![image-20241015205136712](D:\TyporaImage\image-20241015205136712.png)
...
![image-20241015200247069](D:\TyporaImage\image-20241015200247069.png)
...
![image-20241015203331660](D:\TyporaImage\image-20241015203331660.png)

![image-20241015203407197](D:\TyporaImage\image-20241015203407197.png)
...
![image-20241015203544703](D:\TyporaImage\image-20241015203544703.png)



之前的复习：

![image-20241015203631773](D:\TyporaImage\image-20241015203631773.png)
...
**每一个区域的对应的能量**（**得是光线和面得是垂直的，不然不是单位能量。**不是垂直就**投影到垂直**——所以之前的布林冯模型的diffuse term才要做cosθ）<img src="D:\TyporaImage\image-20241015210018430.png" alt="image-20241015210018430" style="zoom:33%;" />——顺便还能解释太阳和地球的角度变化带来的四季变化

公式人话说就是：用能量微分除以面积微分

![image-20241015205443926](D:\TyporaImage\image-20241015205443926.png)



- ### Irradiance Falloff

  - ![image-20241015210608490](D:\TyporaImage\image-20241015210608490.png)
  - 球的面积：4πr^2^
  - Irradiance——单位面积的能量
...
- #### **定义**
  ...
  - ![image-20241015211502812](D:\TyporaImage\image-20241015211502812.png)
  - 人话逻辑就是有一个方向有面积个量的能量辐射出来，差不多就是描述光的了 （往下理解）

- ### 定义理解

  - <img src="D:\TyporaImage\image-20241015212259300.png" alt="image-20241015212259300" style="zoom:50%;" />
  -  将前面的两个量联系起来，也就是：
...
- **Irradiance vs. Radiance**——区别与关系
  - <img src="D:\TyporaImage\image-20241015214141174.png" alt="image-20241015214141174" style="zoom:50%;" />
...
![image-20241015215926870](D:\TyporaImage\image-20241015215926870.png)

![image-20241015220157570](D:\TyporaImage\image-20241015220157570.png)
...
- <img src="D:\TyporaImage\image-20241015221431915.png" alt="image-20241015221431915" style="zoom:50%;" />
- 这个就是**光线传播着色模型**
- **解读**
  - 假设反射对应法则已知<img src="D:\TyporaImage\image-20241015221506013.png" alt="image-20241015221506013" style="zoom:50%;" />，那我们从定点的光照强度对于该方向上的贡献那就可求为<img src="D:\TyporaImage\image-20241015221543095.png" alt="image-20241015221543095" style="zoom:80%;" />，每一条光线对应的Radiance在此方向上的贡献。
...
- **这个反射方程（BRDF）传递一种讯息：**
  - ![image-20241015222512976](D:\TyporaImage\image-20241015222512976.png)这个传入过来的光可不单单只是光源传递过来的光，还有可能是其他物体打过来的光（涉及全局光)——递归的定义方式
...
![image-20241015222840492](D:\TyporaImage\image-20241015222840492.png)
...
![image-20241015223714416](D:\TyporaImage\image-20241015223714416.png)
...
![image-20241015223809331](D:\TyporaImage\image-20241015223809331.png)
...
![image-20241015223950416](D:\TyporaImage\image-20241015223950416.png)
...
- ![image-20241015224542537](D:\TyporaImage\image-20241015224542537.png)

- 写成这样是因为需要解渲染方程
- 近似推导过程
- 涉及矩阵；泰勒展开式
- ![image-20241015224746482](D:\TyporaImage\image-20241015224746482.png)

- 展出来的式子很有意义：
- ![image-20241015224840933](D:\TyporaImage\image-20241015224840933.png)
  - K的幂就表示弹射次数
...
![image-20241015230523352](D:\TyporaImage\image-20241015230523352.png)
...
![image-20241015230908772](D:\TyporaImage\image-20241015230908772.png)

正态分布？

这个时候所说的概率不是y轴，而是某个区域的面积才是概率

上面的曲线叫做概率**密度函数（PDF——OProbability Distribution Function）**——<img src="D:\TyporaImage\image-20241015231020799.png" alt="image-20241015231020799" style="zoom:33%;" />这个取值是符合概率密度的。
...
- **满足属性**
  - <img src="D:\TyporaImage\image-20241015231117160.png" alt="image-20241015231117160" style="zoom:67%;" />
  - 下面部分所有的值进行积分的数等于1（原本是求面积的为概率）
  - 期望**E[X]**计算方式：对于值 * 微分面积
- 如果求得是X的函数的期望怎么求？
  - 题意：<img src="D:\TyporaImage\image-20241015231359260.png" alt="image-20241015231359260" style="zoom:50%;" />
  - 求期望不就是值乘概率然后所有加起来吗，那这个也照做
  - <img src="D:\TyporaImage\image-20241015231434392.png" alt="image-20241015231434392" style="zoom:50%;" />
...
![image-20241018144257603](D:\TyporaImage\image-20241018144257603.png)
...
- 例如，假设 f(x)在一个区间有显著的峰值，我们可以选择 p(x)为一个与该峰值位置相符的概率分布，例如高斯分布：<img src="D:\TyporaImage\image-20241018153941493.png" alt="image-20241018153941493" style="zoom: 67%;" />
...
![image-20241018150409585](D:\TyporaImage\image-20241018150409585.png)
...
- **Reasonable**？
  ...
  - ——**渲染方程√**
    - ![image-20241018160908769](D:\TyporaImage\image-20241018160908769.png)
...
- ### 解渲染方程
  ...
  - #### 蒙特卡洛积分
    ...
    - f（x） = <img src="D:\TyporaImage\image-20241018160928589.png" alt="image-20241018160928589" style="zoom:67%;" />
    - ![image-20241018161109910](D:\TyporaImage\image-20241018161109910.png)
    - 积分表示为：
    - ![image-20241018161134424](D:\TyporaImage\image-20241018161134424.png)

  - ### 伪代码（直接光照）

    - ![image-20241018161626225](D:\TyporaImage\image-20241018161626225.png)
  ...
  - **间接光照**
    ...
    - 伪代码：
      ...
      - ![image-20241018162004056](D:\TyporaImage\image-20241018162004056.png)
...
- ### 问题
  ...
  - ![image-20241018162641717](D:\TyporaImage\image-20241018162641717.png)
  - 只有N = 1的时候才不会爆炸式增长
...
- ### 此时伪代码
  ...
  - ![image-20241018162941616](D:\TyporaImage\image-20241018162941616.png)
...
- 修改后对于单个像素的多个pass，**解决单次N造成的多噪声问题**
  ...
  - ![image-20241018163520608](D:\TyporaImage\image-20241018163520608.png)
...
- **解决递归的归（stop）**
  ...
  - <img src="D:\TyporaImage\image-20241018165519094.png" alt="image-20241018165519094" style="zoom:33%;" />，一定概率情况下不发射，一定概率情况下发射，概率P仍然可以自定义，计算得到的期望值**E(Lo)**仍然不变
  - **俄罗斯轮盘赌伪代码——**
  - <img src="D:\TyporaImage\image-20241018165707199.png" alt="image-20241018165707199" style="zoom:67%;" />
...
![image-20241018170012930](D:\TyporaImage\image-20241018170012930.png)
...
- ### 定位问题
  ...
  - 首先要明确一点，我们为什么能改变采样方法？因为：蒙特卡洛方法并没有规定pdf的选取，我们可以选择任意一个合适的pdf进行采样！以此来大大减少光线的浪费，此时**采样对象就从半球立体角dw转换到了光源表面的微面元dA**：![image-20241020171334772](D:\TyporaImage\image-20241020171334772.png)
...
- ### 解决光线浪费的问题
  ...
  - 因为蒙特卡洛积分只能对需要积分的点才有效，因此需要构建一个关系式，将光源映射到积分点上，即
    - <img src="D:\TyporaImage\image-20241018173402978.png" alt="image-20241018173402978" style="zoom:50%;" />，对应模型<img src="D:\TyporaImage\image-20241018173415261.png" alt="image-20241018173415261" style="zoom:33%;" />
  - 根本方式就是改变积分域，将原先点上的积分改成光源的积分，通过光源映射回shading point上
    - ![image-20241018173558995](D:\TyporaImage\image-20241018173558995.png)
...
- ### ==解决方案——拆解为直接光照与间接光照==
  ...
  - 伪代码：
  - ![image-20241018173957897](D:\TyporaImage\image-20241018173957897.png)
...
- ### 还是有个小问题
  ...
  - ![image-20241018174344958](D:\TyporaImage\image-20241018174344958.png)
...
- #### 照片级真实感
  ...
  - ![image-20241018174710064](D:\TyporaImage\image-20241018174710064.png)
...
![image-20241021171001036](D:\TyporaImage\image-20241021171001036.png)
...
- ### Glossy 材质（BRDF）
  - 经过打磨之后的金属，表面略微粗糙却仍然能够反射<img src="D:\TyporaImage\image-20241021171553327.png" alt="image-20241021171553327" style="zoom:50%;" />
- Ideal reflective / refractive 材质（BSDF*）<img src="D:\TyporaImage\image-20241021171703291.png" alt="image-20241021171703291" style="zoom: 25%;" />
  - 有反射有折射 
    - 如果折射没被吸收——很透的玻璃
    - 如果折射被部分吸收——有点颜色的玻璃<img src="D:\TyporaImage\image-20241021171909462.png" alt="image-20241021171909462" style="zoom:33%;" />
    - 如果折射被完全吸收——黑的（金属完全吸收）
...
- ### 完美的镜面反射
  ...
  - 根据老师给的：<img src="D:\TyporaImage\image-20241021173108086.png" alt="image-20241021173108086" style="zoom:50%;" />

    - 我自己推导了一遍<img src="D:\TyporaImage\image-20241021173141886.png" alt="image-20241021173141886" style="zoom:50%;" />
    - 用的就是第一个的**平行四边形法则**
...
- ### 折射
  ...
  - 对于入IOR盒出IOR定义两个不同的折射率，使其满足：<img src="D:\TyporaImage\image-20241021174729910.png" alt="image-20241021174729910" style="zoom:50%;" />

  - <img src="D:\TyporaImage\image-20241021174815792.png" alt="image-20241021174815792" style="zoom: 80%;" />

  - 从方位角上来看，仍然满足相差一个π的关系

  - 相关折射表![image-20241021174856701](D:\TyporaImage\image-20241021174856701.png)
...
- ### 折射角的计算
  ...
  - 我们要计算它的余弦
  - ![image-20241021175023195](D:\TyporaImage\image-20241021175023195.png)

  - 这个角度在某些情况下是没有意义的——<img src="D:\TyporaImage\image-20241021175243175.png" alt="image-20241021175243175" style="zoom:50%;" />，也就是说在这种情况下是不会发生折射的。
  - 进一步推导，也就是<img src="D:\TyporaImage\image-20241021175308466.png" alt="image-20241021175308466" style="zoom:67%;" />。
...
- ### 从高IOR到低IOR看过去
  ...
  - ![image-20241021210446760](D:\TyporaImage\image-20241021210446760.png)
...
- ### Fresnel Reflection（菲尼尔项） / Term
  ...
  - **反射强度随着掠射角的增大而增大**
  - **导体**的菲涅尔现象
  - <img src="D:\TyporaImage\image-20241021211314992.png" alt="image-20241021211314992" style="zoom:50%;" />
  - **绝缘体**（镜子）的菲涅尔现象
  - <img src="D:\TyporaImage\image-20241021211634793.png" alt="image-20241021211634793" style="zoom:50%;" />
    - 在各个角度的反射程度都几乎相同
  - 完全正确计算方式——对两个级数取平均
    - ![image-20241021211954642](D:\TyporaImage\image-20241021211954642.png)
  - **Schlick’s 近似公式**
    - ![image-20241021212023100](D:\TyporaImage\image-20241021212023100.png)
...
- ### **微表面材质（Microfacet Material）**
  ...
  - 根据微表面的法线对光照进行分布
    ...
    - ![image-20241021212928555](D:\TyporaImage\image-20241021212928555.png)

    - 根据微面元理论，推出微面元模型的计算公式：

    - ![image-20241021213404860](D:\TyporaImage\image-20241021213404860.png)
...
- ### **第二类材质——各向异性（Anisotropic）**
  ...
  - ![image-20241021214657440](D:\TyporaImage\image-20241021214657440.png)



- ### BRDF性质

  - **非负性：**<img src="D:\TyporaImage\image-20241021220117398.png" alt="image-20241021220117398" style="zoom:50%;" />，能量分布肯定是正的
  - **线性性质：**可以通过累加获得结果，跟各部分算结果然后累加是一样的。就像这个图里面好多个几何体都可以加起来一眼。![image-20241021220220898](D:\TyporaImage\image-20241021220220898.png)

  - **可逆性：**出射光与入射光的方向可互换，中间不涉及转换<img src="D:\TyporaImage\image-20241021220356233.png" alt="image-20241021220356233" style="zoom: 33%;" />

  - **能量守恒**：能量只会不变或者越来越小，总体肯定不会超过原始输入能量<img src="D:\TyporaImage\image-20241021220514844.png" alt="image-20241021220514844" style="zoom:50%;" />

  - **各向同性：**

    - 实际上是**三维**的，只包含入射角度，出射角度以及两者的**相对角度**——<img src="D:\TyporaImage\image-20241021220800287.png" alt="image-20241021220800287" style="zoom:33%;" />
...
- ### BRDF的测量
  ...
  - <img src="D:\TyporaImage\image-20241021220929783.png" alt="image-20241021220929783" style="zoom:50%;" />
...
- ### BRDF的存储
  ...
  - 神经网络压缩
  - 测入射出射角，相对方位角的绝对值即可<img src="D:\TyporaImage\image-20241021221340698.png" alt="image-20241021221340698" style="zoom:50%;" />
...
- <img src="D:\TyporaImage\image-20241022143654973.png" alt="image-20241022143654973" style="zoom:50%;" />
...
- ### 实现方法（其一）
  ...
  - Photon Mapping — Approach (variations apply)
    ...
    3. ###### Calculation — local density estimation 局部光子密度估计
       ...
       - 一种思想：光子越多的区域就越亮
       - 可以快速得到一个shading point周围的**N个光子**(通过树状结构实现算法，N是固定的，用**光子个数来决定面积**). 然后计算着N个光子所占据的面积（球）<img src="D:\TyporaImage\image-20241022160741026.png" alt="image-20241022160741026" style="zoom:25%;" />，面积计算，然后**光子密度=光子数量/面积**
       - 光子数量少：面积大，噪声大；光子数量大：模糊。主要是——<img src="D:\TyporaImage\image-20241022160904877.png" alt="image-20241022160904877" style="zoom:33%;" />，对于密度的估计是不正确的估计。↓

    4. ###### 模糊是因为有偏

       - Local Density estimation dN / dA != ΔN / ΔA **光子密度估计在数量趋向无限时才与真正光子密度相等**，所以biased but **==consistent!==**——<img src="D:\TyporaImage\image-20241022160938695.png" alt="image-20241022160938695" style="zoom:33%;" />。 只要打出的光子不是趋于无线的，那它就是有偏的，那多少都会有一点糊。
...
- 想法很简单：
  ...
  - ![image-20241022162040747](D:\TyporaImage\image-20241022162040747.png)
...
- 在一个介质点上，点的表现力和物体表面的表现能力类似。能够达到：**能量损耗，自发光，光线能量散射以及吸收光线**等行为。<img src="D:\TyporaImage\image-20241022163638607.png" alt="image-20241022163638607" style="zoom:50%;" />

  - **怎么进行散射？**

    - 可以往各个不同的方向散射。（倾向于光的方向散射是不是可以说是光线步进？）
    - **==Phase Function==**（相位函数）来定义，自规定散射方式
    - ![image-20241022163936839](D:\TyporaImage\image-20241022163936839.png)
...
![img](D:\TyporaImage\https%3A%2F%2Fs3-us-west-2.amazonaws.com%2Fsecure.notion-static.com%2F4a4bd1ad-1b13-404a-a728-429c59cf0400%2FUntitled.png)
...
- ### Kajiya-Kay Model——KK模型
  ...
  - <img src="D:\TyporaImage\image-20241022164949179.png" alt="image-20241022164949179" style="zoom:33%;" />
  - 效果<img src="D:\TyporaImage\image-20241022165133925.png" alt="image-20241022165133925" style="zoom:33%;" />
...
- ### Marschner Model
  ...
  - <img src="D:\TyporaImage\image-20241022165515836.png" alt="image-20241022165515836" style="zoom:50%;" />
  - 思考的模型：
    - Glass-like cylinder
    - <img src="D:\TyporaImage\image-20241022165846587.png" alt="image-20241022165846587" style="zoom:33%;" />
    - **皮质部分（cortex）**：有色素，会吸收部分能量
    - **角质层（cuticle）**：就是外层，穿透层
  - 效果：![image-20241022170030278](D:\TyporaImage\image-20241022170030278.png)
...
- 人类的头发和动物毛发的区别：
  - <img src="D:\TyporaImage\image-20241022170510117.png" alt="image-20241022170510117" style="zoom:67%;" />
  ...
  - 加入了髓质的影响之后：人类的头发也更加透气一点（散射能力更强）
    - ![image-20241022171119035](D:\TyporaImage\image-20241022171119035.png)
...
- ### Double Cylinder Model——双层圆柱体模型
  ...
  - **==R+TT+TRT+TT^s^+TRT^s^==**
  - <img src="D:\TyporaImage\image-20241022171631615.png" alt="image-20241022171631615" style="zoom:50%;" />
  - 三个叠加的效果如下，我感觉已经特别好了，Yan双层圆柱形模型！
  - ![image-20241022171715690](D:\TyporaImage\image-20241022171715690.png)



#### Granular Material——颗粒材质

![image-20241022172135286](D:\TyporaImage\image-20241022172135286.png)
...
- ### Subsurface Scattering——次表面反射
  ...
  - 场景——胶体，丁达尔效应，较为通透的物体等<img src="D:\TyporaImage\image-20241022172827800.png" alt="image-20241022172827800" style="zoom:33%;" />

  - **==BSSRDF==**（中间加了个Subsurface Scattering）计算

    - ![image-20241022173139248](D:\TyporaImage\image-20241022173139248.png)
    - ![image-20241022173229470](D:\TyporaImage\image-20241022173229470.png)
      - 从哪个点进来
      - 从哪个方向进来
      - 从那个点出去
      - 从哪个方向出去
  ...
  - ### **Dipole Approximation近似方法**
    ...
    - <img src="D:\TyporaImage\image-20241022173611228.png" alt="image-20241022173611228" style="zoom:50%;" />
    - 效果不错

  - ### 应用场景

    - 通透的皮肤<img src="D:\TyporaImage\image-20241022173720448.png" alt="image-20241022173720448" style="zoom: 25%;" />
    - 玉石
...
- ### 	 **Microfacet BRDF**
  ...
  - <img src="D:\TyporaImage\image-20241022175343549.png" alt="image-20241022175343549" style="zoom:50%;" />
  ...
  - ### Recent Trend: Wave Optics
    ...
    - <img src="D:\TyporaImage\image-20241022200134015.png" alt="image-20241022200134015" style="zoom:50%;" />
    - 然后就要考虑波动光学
      - 结果与几何光学类似，但不连续（干涉导致），不同波长也不一样，老师也不想提
      - <img src="D:\TyporaImage\image-20241022200255395.png" alt="image-20241022200255395" style="zoom:50%;" />
      - <img src="D:\TyporaImage\image-20241022200352944.png" alt="image-20241022200352944" style="zoom:33%;" />——波动光学
...
- #### 相机的原理
  ...
  - 小孔成像<img src="D:\TyporaImage\image-20241022203019291.png" alt="image-20241022203019291" style="zoom:25%;" />
    - 针孔相机 Pinhole Camera
      - 无虚化
      - 全部都是清晰的
  - **Lens 透镜成像**<img src="D:\TyporaImage\image-20241022203025701.png" alt="image-20241022203025701" style="zoom:25%;" />
...
![image-20241022204000521](D:\TyporaImage\image-20241022204000521.png)

- **h:** 传感器高度
- **f:** 焦距，传感器与透镜的距离

<img src="D:\TyporaImage\image-20241022204103919.png" alt="image-20241022204103919" style="zoom:33%;" />
...
- 传感器Sensor和胶片Film不一定一样
  ...
  - ![img](D:\TyporaImage\https%3A%2F%2Fs3-us-west-2.amazonaws.com%2Fsecure.notion-static.com%2Fa6a23b02-0287-4cae-99c5-1466e375cb34%2FUntitled.png)
...
- ### 曝光程度的控制
  ...
  - **ISO gain 感光度**
    ...
    - 为什么会产生噪声？
      ...
      - ![img](D:\TyporaImage\https%3A%2F%2Fs3-us-west-2.amazonaws.com%2Fsecure.notion-static.com%2F1d9586d5-ad26-4c6d-ac25-bcf3ebac393b%2FUntitled.png)
...
- ![image-20241022213029288](D:\TyporaImage\image-20241022213029288.png)
...
![image-20241022214451515](D:\TyporaImage\image-20241022214451515.png)

- **Z~o~：物距**，物体到透镜的距离（物象在聚焦位置）
- **Z~i~：像距**，胶片到透镜的距离（成像在聚焦位置）
- **f：焦距**，两边的焦点到透镜的距离

The (Gaussian) Thin Lens Equation:![image-20241022214031445](D:\TyporaImage\image-20241022214031445.png)
...
- ## 解释 Defocus Blur 虚化的原因
  ...
  ![img](D:\TyporaImage\https%3A%2F%2Fs3-us-west-2.amazonaws.com%2Fsecure.notion-static.com%2Fd88de14d-aabc-469c-ad91-644315bfbb14%2FUntitled.png)
...
- ### 光圈的完整定义
  ...
  - ![image-20241022215720754](D:\TyporaImage\image-20241022215720754.png)
...
- 渲染的时候
  - 遍历每一个胶片上的像素x‘
  - 在透镜上随机采样一个点x’‘
  - 通过计算，可以知道光线会穿过物距上的一个点x’‘’（公式<img src="D:\TyporaImage\image-20241022215720754.png" alt="image-20241022215720754" style="zoom: 67%;" />)
  - ![image-20241022220139502](D:\TyporaImage\image-20241022220139502.png)
...
![image-20241022221309985](D:\TyporaImage\image-20241022221309985.png) 
...
- ### The Plenoptic Function（全光函数）
  ...
  - 灰度快照：从维度逐渐递推，定义一个对应法则，假如从场景中某一点某个角度所观察<img src="D:\TyporaImage\image-20241024120829148.png" alt="image-20241024120829148" style="zoom:50%;" />，看到的就是黑白的世界
  - 颜色快照：如果引入波长的概念，对于光有不同的波长<img src="D:\TyporaImage\image-20241024120953923.png" alt="image-20241024120953923" style="zoom:50%;" />，看到的就是彩色的世界
    - Seen from a single view point
    - At a single time
    - As a function of wavelength 彩色
  - 电影：再引入一个时间变量，可以达到帧效果，也就是可以动起来<img src="D:\TyporaImage\image-20241024121804608.png" alt="image-20241024121804608" style="zoom:50%;" />
    - is intensity of light
    - Seen from a single view point
    - Over time
    - As a function of wavelength 彩色
  - **全息电影/全光函数**：引入空间位置变量，使得可以从其他方位对场景进行观察，<img src="D:\TyporaImage\image-20241024122008853.png" alt="image-20241024122008853" style="zoom:50%;" />
    - is intensity of light
...
- ### Ray光线
  ...
  - <img src="D:\TyporaImage\image-20241024122618906.png" alt="image-20241024122618906" style="zoom:50%;" />
...
- ### Light Field Camera
  ...
  - Lytro: founded by Prof. Ren Ng (UC Berkeley)
    ...
    - Each pixel (irradiance) is now stored as a block of pixels (radiance)<img src="D:\TyporaImage\image-20241024142311205.png" alt="image-20241024142311205" style="zoom:33%;" />
...
![image-20241024143103020](D:\TyporaImage\image-20241024143103020.png)

**一个点记录多个方向的光照强度，就如：**

![image-20241024143008877](D:\TyporaImage\image-20241024143008877.png)
...
- **Spectral Power Distribution (SPD) 谱功率密度：**描述一束光在所有波长的分布
  ...
  - ![image-20241024144318407](D:\TyporaImage\image-20241024144318407.png)
...
- #### Eyes
  ...
  - Cones：视锥细胞，锥形，较少，产生“颜色”的感觉
    - Three types of cones S, M, and L (corresponding to peak response at short, medium, and long wavelengths), each with different spectral sensitivity![image-20241024145456758](D:\TyporaImage\image-20241024145456758.png)
...
![image-20241024150225566](D:\TyporaImage\image-20241024150225566.png)
...
- ### Metamerism （同⾊异谱）
  ...
  - ![image-20241024150615527](D:\TyporaImage\image-20241024150615527.png)
...
- ### Color Reproduction / Matching 颜色匹配、重建
  ...
  - ![image-20241024151255769](D:\TyporaImage\image-20241024151255769.png)
  - 有些颜色怎么混合也混不出来，但是通过给原色加色，就可以混合出来，那么将最后混合的颜色中减去加上的颜色，就是对这种颜色的表示→系数会有负数！——理解为反过来实际上就是目标颜色加上某个颜色。![image-20241024151551608](D:\TyporaImage\image-20241024151551608.png)
  - 
...
- #### CIE RGB Color Matching Experiment
  ...
  - 假如我们要这么一个光![image-20241024151759200](D:\TyporaImage\image-20241024151759200.png)，然后我们用RGB去做颜色匹配，得到我需要的RGB各自的波长是多少<img src="D:\TyporaImage\image-20241024151834803.png" alt="image-20241024151834803" style="zoom:50%;" />
  ...
  - <img src="D:\TyporaImage\image-20241024151920824.png" alt="image-20241024151920824" style="zoom:50%;" />
...
- 还记得之前说：任何一束光（光谱）→人眼视网膜 → (S,M,L) → Color 的对应，人眼只知道**(S,M,L)**，不知道原来的光线分布（SPD），这里实际上干的是差不多的事情（类似于响应积分，但不同）
  ...
  - <img src="D:\TyporaImage\image-20241024152617924.png" alt="image-20241024152617924" style="zoom:50%;" />
...
- #### A Universal Color Space: CIE XYZ
  ...
  - ![image-20241024154025419](D:\TyporaImage\image-20241024154025419.png)
...
![image-20241024154317485](D:\TyporaImage\image-20241024154317485.png)

- ![image-20241024154439264](D:\TyporaImage\image-20241024154439264.png)
...
<img src="D:\TyporaImage\image-20241024155602777.png" alt="image-20241024155602777" style="zoom:50%;" />
...
- ### 关键的技术难点 - Interpolation 插值
  ...
  - 怎样插值流畅怎样插值真实是有讲究的
  - 回忆光滑/可控插值的样条，之前对于线上的每一帧的插值，生成样条。同理，保持某种曲率的方式生成帧做到流畅过度<img src="D:\TyporaImage\image-20241024165428069.png" alt="image-20241024165428069" style="zoom:50%;" />
  - 手动或自动（线性插值）K关键帧
...
![image-20241024214002761](D:\TyporaImage\image-20241024214002761.png)
...
- #### 最简单的弹簧
  ...
  - **劲度系数 * 力的方向**
  - <img src="D:\TyporaImage\image-20241024215511430.png" alt="image-20241024215511430" style="zoom:50%;" />
...
- #### Non-Zero Length Spring
  ...
  - ![image-20241024220342197](D:\TyporaImage\image-20241024220342197.png)

- 常用记法

  - <img src="D:\TyporaImage\image-20241024220651660.png" alt="image-20241024220651660" style="zoom:33%;" />——一个点表示一阶导=速度，两个点表示二阶导=加速度

- ### 引入能量损耗

  - **Simple motion damping 阻尼**<img src="D:\TyporaImage\image-20241024220958750.png" alt="image-20241024220958750" style="zoom:50%;" />（绝对速度阻尼）
    - 表现得就像是有粘性的运动
  ...
  - **Internal Damping for Spring弹簧内部的阻尼** （相对速度阻尼）
    - <img src="D:\TyporaImage\image-20241025133241633.png" alt="image-20241025133241633" style="zoom:50%;" />
  ...
  - **Structures from Springs**
    - 分子模型（这些物理模型的模拟通常都是对现实生活的一种简化，并不能完全代表真实世界）：
      ...
      - Blocks
      - Others
      - <img src="D:\TyporaImage\image-20241025135103893.png" alt="image-20241025135103893" style="zoom:50%;" />
    - **质点弹簧系统**抽象模型模拟
      - ①![image-20241025135811316](D:\TyporaImage\image-20241025135811316.png)
        - 对角线拉扯会切变
        - 对折产生新层无力的作用变回去
      - ②![image-20241025135854116](D:\TyporaImage\image-20241025135854116.png)
        - 往单方面对角线增加支撑
        - 单方面对角线有支撑
        - 另一方面对角线仍然可以被拉产生切变
        - 对折产生新层无力的作用变回去
      - ③![image-20241025135949612](D:\TyporaImage\image-20241025135949612.png)
        - 两边都添加支撑
        - 对角线切变问题解决
        - 对折问题未解决
      - ④![image-20241025140019711](D:\TyporaImage\image-20241025140019711.png)
...
- **粒子系统之间的力**——**==本质上就是定义个体与群体之间的关系==**
  ...
  - **引力和排斥力**
    ...
    - 重力、电磁力，...
    - 弹簧、推进力，...
    - 像地球引力<img src="D:\TyporaImage\image-20241025142443078.png" alt="image-20241025142443078" style="zoom:33%;" />
...
明确骨骼之间的运动关系→计算出各个部位的位置<img src="D:\TyporaImage\image-20241025143425488.png" alt="image-20241025143425488" style="zoom:67%;" />
...
- **关节化骨架**
  ...
  **关节类型**
  ...
  - 滑动关节（平移）——可以拉伸<img src="D:\TyporaImage\image-20241025143655094.png" alt="image-20241025143655094" style="zoom:33%;" />
...
- ![image-20241025143950518](D:\TyporaImage\image-20241025143950518.png)
...
![image-20241025144242995](D:\TyporaImage\image-20241025144242995.png)
...
- ### Motion Data
  ...
  - ![image-20241025150040629](D:\TyporaImage\image-20241025150040629.png)
...
- ### 动画的制作流程
  ...
  - ![image-20241025150337649](D:\TyporaImage\image-20241025150337649.png)
...
![image-20241025162036208](D:\TyporaImage\image-20241025162036208.png)
...
- ### Ordinary Differential Equation (ODE) 常微分方程
  ...
  - 计算速度场内粒子的位置需要计算**一阶常微分方程**：<img src="D:\TyporaImage\image-20241025162404409.png" alt="image-20241025162404409" style="zoom: 67%;" />
    ...
    - 解一阶常微分方程：
      ...
      - 离散：Euler’s Method欧拉方法——用上一帧的属性来估计/计算下一帧的属性
        ...
        - Explicit Euler method （forward 前向、显式）
          ...
          - ![image-20241025162724300](D:\TyporaImage\image-20241025162724300.png)
        ...
        - **显式欧拉方法的特性**
          ...
          - 简单的迭代方法
            ...
            - 容易出现正反馈，离正确结果越来越远
            - 如果步长**（△t）**定义的很长，得到的结果会和实际偏差很多<img src="D:\TyporaImage\image-20241025163501289.png" alt="image-20241025163501289" style="zoom:25%;" />
            - 可以通过缩小步长来优化，达到正确的模拟

          - 不稳定的体现：<img src="D:\TyporaImage\image-20241025163725747.png" alt="image-20241025163725747" style="zoom:33%;" />
  ...
  - ### 解决不稳定性
    ...
    - #### Midpoint Method（中点法）
      ...
      - <img src="D:\TyporaImage\image-20241025165801431.png" alt="image-20241025165801431" style="zoom:50%;" />
      - 先根据欧拉步骤计算出点a（在一个步长△t里面）
      - 然后取原点和a的中点b
      - 取得中点b的瞬时速度
      - 在原点根据中点b取得的瞬时速度和步长计算c点的位置（那条曲线是c按照我们所想的实际规律应该走的路径和应该到达点c的位置），与理想路线的点c位置几乎一样。
      - 逻辑公式：<img src="D:\TyporaImage\image-20241025170222706.png" alt="image-20241025170222706" style="zoom:50%;" />
      - 计算公式：<img src="D:\TyporaImage\image-20241025170312021.png" alt="image-20241025170312021" style="zoom:67%;" />
      - 为啥中点法能够准确模拟落点？
        - 因为多了个二次项，模拟了抛物线的运动轨迹

    - #### Adaptive Step Size——自适应

      - <img src="D:\TyporaImage\image-20241025171255295.png" alt="image-20241025171255295" style="zoom:33%;" />
    ...
    - ### Implicit Euler Method——隐式欧拉方法
      ...
      - <img src="D:\TyporaImage\image-20241025172059428.png" alt="image-20241025172059428" style="zoom:33%;" />
    ...
    - ### Runge-Kutta Families——龙格库塔方法
      ...
      - 四阶版本是最常用的，即 **RK4**
      - 做法：
        - 初始条件![image-20241025173914528](D:\TyporaImage\image-20241025173914528.png)
        - RK4解法![image-20241025173928269](D:\TyporaImage\image-20241025173928269.png)
        - 其中![image-20241025173947918](D:\TyporaImage\image-20241025173947918.png)
...
![image-20241025174945884](D:\TyporaImage\image-20241025174945884.png)
...
- ### Key idea
  ...
  - 更新？只需梯度下降！
  - <img src="D:\TyporaImage\image-20241025180845467.png" alt="image-20241025180845467" style="zoom:50%;" />
...
- ### 流体模拟中两种不同的思路
  ...
  - Lagrangian：**质点法**，以每个元素为单位模拟<img src="D:\TyporaImage\image-20241025181658060.png" alt="image-20241025181658060" style="zoom:50%;" />

  - Eulerian：**网格法**，以空间为单位分割模拟<img src="D:\TyporaImage\image-20241025181704727.png" alt="image-20241025181704727" style="zoom:50%;" />
